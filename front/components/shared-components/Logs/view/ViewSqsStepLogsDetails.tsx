import { LogSqsStepJsonld } from "@/services";
import {
    Tabs,
    TabsContent,
    TabsList,
...
interface ViewSqsStepLogsDetailsProps {
    log: {
        step: LogSqsStepJsonld;
    };
}

export function ViewSqsStepLogsDetails(props: ViewSqsStepLogsDetailsProps) {
    const { log } = props;
    const { step } = log;
