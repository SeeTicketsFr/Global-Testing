...
// May contain unused imports in some cases
// @ts-ignore
import { ScenarioMetricsJsonldMetricsRead } from './scenario-metrics-jsonld-metrics-read';

/**
 * 
 * @export
 * @interface ApiScenarioMetricssGetCollection200Response
 */
export interface ApiScenarioMetricssGetCollection200Response {
    /**
     * 
     * @type {Array<ScenarioMetricsJsonldMetricsRead>}
     * @memberof ApiScenarioMetricssGetCollection200Response
     */
    'hydra:member': Array<ScenarioMetricsJsonldMetricsRead>;
    /**
     * 
     * @type {number}
     * @memberof ApiScenarioMetricssGetCollection200Response
