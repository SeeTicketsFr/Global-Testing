 ...
 * 
 * @export
 * @interface ApiDocumentationJsonldApidocumentationRead
 */
export interface ApiDocumentationJsonldApidocumentationRead {
    /**
     * 
     * @type {AbstractStepJsonldScenarioReadStepReadHttpstepReadLoopstepReadSleepstepReadSqsstepReadMetricsReadWebhookReadContext}
     * @memberof ApiDocumentationJsonldApidocumentationRead
     */
